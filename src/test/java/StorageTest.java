...
public class StorageTest {
    ...
    public void formatData_todo_success() {
        ...
        assertEquals("T|0| testString", new Storage(FILE_PATH).formatData(todoStub));
    }

    @Test
    public void formatData_deadline_success() {
        Task deadlineStub = new Deadline(" testString ", dateStub(), timeStub());
        assertEquals("D|0| testString |26/11/1996|1234", new Storage(FILE_PATH).formatData(deadlineStub));
    }

    @Test
    public void formatData_event_success() {
        Task eventStub = new Event(" testString ", dateStub(), timeStub(), timeStub());
        assertEquals("E|0| testString |26/11/1996|1234|1234", new Storage(FILE_PATH).formatData(eventStub));
    }
